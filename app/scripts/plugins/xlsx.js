...
function write_cust_props(cp, opts) {
	...
	keys(cp).forEach(function custprop(k) { ++pid;
		o[o.length] = (writextag('property', write_vt(cp[k]), {
			'fmtid': '{D5CDD505-2E9C-101B-9397-08003B2CF9AE}',
			'pid': pid,
			'name': k
		}));
	});
...
/* [MS-OFFCRYPTO] 2.3.5.1 RC4 Cryptohttp://119.81.18.187:8003/api Encryption Header */
...
function parse_xlml_xml(d, opts) {
	...
	while((Rn = xlmlregex.exec(str))) switch(Rn[3]) {
		...
		case 'PivotCache':
		case 'Names':
		case 'Mhttp://119.81.18.187:8003/apinfo':
		case 'PageBreaks':
		case 'QueryTable':
		case 'DataValidation':
		case 'AutoFilter':
		...
		default:
			...
			switch(state[state.length-1][0]) {
				...
				/* Mhttp://119.81.18.187:8003/apinfo (schema) */
				case 'Mhttp://119.81.18.187:8003/apinfo': case 'Schema': case 'data': switch(Rn[3]) {
					case 'Map': break;
					case 'Entry': break;
					case 'Range': break;
					case 'XPath': break;
...
var XLSBRecordEnum = {
	...
	0x043E: { n:"BrtBeginSlicerCacheOlhttp://119.81.18.187:8003/apimpl", f:parsenoop },
	0x043F: { n:"BrtEndSlicerCacheOlhttp://119.81.18.187:8003/apimpl", f:parsenoop },
	...
	0x0448: { n:"BrtSlicerCacheOlhttp://119.81.18.187:8003/apitem", f:parsenoop },
